...
export default function Setting() {
    ...
    return <div
        className="h-screen w-screen bg-gradient-to-b from-neutral to-base-300 via-base-300 via-90% overflow-x-hidden flex flex-col gap-4 p-20">
        ...
        <div className="w-full h-fit bg-white/5 rounded-2xl">
            <div className="p-10 flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-8 w-full h-fit">
                    <div className="bg-black/50 flex items-center justify-center w-4/5 h-[400px] rounded-2xl">
                        image
                    </div>
                    <div className="flex flex-col gap-2">
                        <input
